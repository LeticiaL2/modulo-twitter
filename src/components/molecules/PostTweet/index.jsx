  ...
  return (
    <Container>
      ...
      <FormTweet onSubmit={handlePostTweetData}>
        <InputTweetContainer>
          <Input type="text" placeholder="What's hapenning?!" value={enteredTweet} onChange={handleTweetChange} />
        </InputTweetContainer>
        <ActionsContainer>
          <Button variant="primary" disabled={isButtonDisabled}>Post</Button>
        </ActionsContainer>
      </FormTweet>
    </Container>
  )
